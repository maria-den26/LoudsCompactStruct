...
| | LOUDS | Trie |
|-|-------|------|
| Сложность поиска потомка| O(1) | O(n), где n - длина ключа |
| Операции добавления/удаления узла | Не поддерживаются без дополнительных структур данных | Поддерживаются |
